    ...
    <div>
      ...
      <h2>HEYTEA</h2> 
        <Nav>
          ...
          <h5> Type </h5>
          <Nav.Item>
            <button className="button" onClick={() => setState({ type: "All" })}>Reset/All</button>
          </Nav.Item>
          <Nav.Item>
            <button className="button" onClick={() => onSelectFilterType("cheezo fruit tea")}>Cheezo fruit tea</button>
          </Nav.Item>
          <Nav.Item>
            <button className="button" onClick={() => onSelectFilterType("bobo milk tea")}>Bobo family</button>
          </Nav.Item>
          <Nav.Item>
            <button className="button" onClick={() => onSelectFilterType("fruity boom")}>Fruity boom</button>
          </Nav.Item>
          <Nav.Item>
            <button className="button" onClick={() => onSelectFilterType("coffee")}>Coffee savory</button>
          </Nav.Item>
        </Nav>
        ...
        <Nav>
          <h5> Temperature </h5>
          <Nav.Item>
            <button className="button"  onClick={() => setRes({ restrictions: "All" })}>Reset/All</button>
          </Nav.Item>
          <Nav.Item>
            <button className="button"  onClick={() => onSelectFilterRes("cold only")}>Cold only</button>
          </Nav.Item>
          <Nav.Item>
            <button className="button" onClick={() => onSelectFilterRes("cold and hot")}>Cold and hot</button>
          </Nav.Item>
        </Nav>
        ...
        <Nav>
          <h4> Sort by </h4>
          <Nav.Item>
            <button className="button"  onClick={() => onSelectSort("default")}>Category/default</button>
          </Nav.Item>

          <Nav.Item>
            <button className="button"  onClick={() => onSelectSort("price")}>Price(low to high)</button>
          </Nav.Item>

          <Nav.Item>
            <button className="button"  onClick={() => onSelectSort("priceHigh")}>Price(high to low)</button>
          </Nav.Item>

          <Nav.Item>
            <button className="button"  onClick={() => onSelectSort("calories")}>Calories</button>
          </Nav.Item>

          <Nav.Item>
            <button className="button" onClick={() => onSelectSort("pop")}>Popularity</button>
          </Nav.Item>
        </Nav>
      </div>
